...
const ContestantsFeatures = () => {
  return (
    <div className="flex flex-col bg-[#030814]">
      <Bounded className="h-[375px] md:min-h-[750px] md:h-screen py-0 md:py-16 relative flex items-center justify-center">
        ...
        <div className="z-10 absolute inset-x-0 top-5 md:top-12 flex items-center justify-center">
          <Image
            ...
            alt="2024"
            className="max-h-[175px] md:max-h-[350px] h-[175px] md:h-[350px] max-w-[341px] md:max-w-[895px]"
        ...
        <Image
          src="/images/contestants/main-bg.png"
      ...
      <Bounded className="h-[375px] flex flex-col w-full relative">
...
export default ContestantsFeatures;
