...
const images = [
  ...
  "/images/home/introduction/Img-1.png",
  "/images/home/introduction/Img-2.png",
  "/images/home/introduction/Img-3.png",
];
const Introduction = () => {
        ...
        <div className="grid grid-cols-5">
          <div className="md:sticky top-0 md:h-screen flex items-center justify-center col-span-5 md:col-span-3">
            <div className="flex flex-col items-start justify-center py-12 md:p-16 z-10 gap-6">
              <h3 className="text-white text-[13px] leading-[18px] lg:text-xl uppercase font-unbounded">
                Introduction
              </h3>
              <h1 className="text-white text-base md:text-5xl font-bold uppercase font-unbounded">
                Mister{" "}
              ...
              <p className="text-white text-[13px] leading-[18px] md:text-[15px] md:leading-[21px] font-montserrat">
                The 8th edition of Mister Tourism World, scheduled to be held in
                Vietnam, is expected to attract participants from 35 countries
                around the world, aiming to showcase the rich culture and
                tourism of Vietnam. The event will contribute to promoting
                Vietnamese tourism, cuisine, people, and culture, ultimately
                helping to highlight the image of a dynamic, modern, and
                friendly country to the international community. <br /> <br />
                Vietnam has previously sent three contestants to the
                competition: Pham Xuan Hien (2016) and Tran Manh Kien (2017),
                who did not achieve high rankings; Phung Phuoc Thinh (2022) who
                won the title of 5th Runner-up; and Nguyen Quoc Tri (2023) who
                secured the position of 3rd Runner-up. <br /> <br />
                For the first time, Vietnam has been chosen to host the Mister
                Tourism World competition, which will take place in February
                2025, covering locations such as Ho Chi Minh City, Dong Nai, Ba
                Ria - Vung Tau, Binh Thuan, and Ninh Thuan.
              </p>
            </div>
          </div>
